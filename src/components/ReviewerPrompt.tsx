 ...
 *
 * There is deliberately no way out but choosing. The app withholds the form
 * without a seat anyway, so a dismiss button would only offer a state in which
 * nothing can be done; and the choice is free, reversible from the toolbar, and
...
export function ReviewerPrompt() {
  ...
  if (!project || project.reviewers <= 1 || currentReviewer !== null) return null
